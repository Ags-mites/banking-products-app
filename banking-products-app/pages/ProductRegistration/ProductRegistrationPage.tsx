...
import { useProductRegistration } from '../../features/productRegistration/useProductRegistration';
...
export function ProductRegistrationPage() {
  const { form, errors, networkError, successMessage, loading, handleChange, handleSubmit, handleReset } =
        ...
        >
            ...
            {!!successMessage && (
              <View style={styles.successBanner} testID="success-message">
                ...
                <Text style={styles.successSub}>Regresando a la lista...</Text>
              </View>
            )}

            {!!networkError && (
              <Text style={styles.networkError} testID="network-error">
                {networkError}
              </Text>
            )}
