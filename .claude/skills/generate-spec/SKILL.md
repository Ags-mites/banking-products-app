...
- [ ] Términos canónicos del dominio (ver `CLAUDE.md` → Diccionario de Dominio)
...
- [ ] Alineada con arquitectura y stack (ver `.claude/rules/frontend.md`)
...
2. Lee las rules: `.claude/rules/frontend.md`
...
- `## 3. LISTA DE TAREAS` — checklists frontend `[ ]`, QA `[ ]`
