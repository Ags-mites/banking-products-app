...
description: Implementa funcionalidades en el frontend. Úsalo cuando hay una spec aprobada y se necesita implementar el frontend.
...
|------|-----------------|-----------|
| **Services** | Llamadas HTTP a la API | Estado, lógica de negocio |
