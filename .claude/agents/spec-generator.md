...
1. Con la información ya cargada, explora el código para identificar componentes afectados (no duplicar lo existente)
...
- `## 2. DISEÑO` — componentes frontend, servicios, hooks
- `## 3. LISTA DE TAREAS` — checklists accionables para frontend y QA
